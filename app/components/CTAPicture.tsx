...
const CTAPicture = () => {
	return (
		<div className='relative h-[515px] w-full bg-[url(/images/Image.png)] bg-cover bg-left bg-no-repeat rounded-[4px]'>
			<div className='absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-[#141414] opacity-[.80] to-transparent rounded-[4px]'/>
			<div className='absolute bottom-4 right-4 left-4 z-10 items-center flex justify-between'>
				<div>
